...
export declare const initCustomerContext: () => Promise<boolean>;
export declare const showPaymentOptionsModal: (cartTotal: number) => void;
export declare const getPaymentMethodId: (items: ApplePay.CartSummaryItem[]) => Promise<string>;
export declare const paymentRequestWithApplePay: (items: ApplePay.CartSummaryItem[], options: any) => Promise<void>;
